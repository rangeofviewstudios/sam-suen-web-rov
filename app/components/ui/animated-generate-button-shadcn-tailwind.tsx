...
export default function AnimatedGenerateButton({
  ...
  generating = false,
  // Default to the Sam Suen brand red (maroon family) so the glow stays on-brand.
  highlightHueDeg = 0,
  onClick,
  type = "button",
  disabled = false,
    ...
    <div className={clsx("relative inline-block", className)} id={id}>
      <button
        ...
        className={clsx(
          ...
          // Project tokens instead of shadcn's --background/--foreground/--border.
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper relative flex min-w-[5.5em] items-center justify-center">
          <div
            className={clsx(
              "ui-anim-txt-1 absolute inset-0 flex items-center justify-center whitespace-pre",
          ...
          <div
            className={clsx(
              "ui-anim-txt-2 absolute inset-0 flex items-center justify-center whitespace-pre",
      ...
      <style jsx>{`
        ...
        /* Idle text fade-in (kept inside styled-jsx so the keyframe name
           resolves under styled-jsx scoping). */
        .ui-anim-appear {
          animation: ui-appear 1s ease-in-out forwards;
        }
